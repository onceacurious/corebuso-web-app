...
const Header = () => {
  ...
  const _content =
    "Welcome to Corebuso Development Site. This site is for testing only, to submit an inquiry please visit corebuso.com. Some layout/display isn't yet responsive.";
